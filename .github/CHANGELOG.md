...
* Added `.gitattributes` to the repo, so git automatically handles consistent `eol`'s for all contributors across different operating systems. [#78](https://github.com/XanaduAI/flamingpy/pull/78)
